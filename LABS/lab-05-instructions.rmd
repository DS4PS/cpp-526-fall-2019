...
In this lab you will use a traffic accidents dataset from the Tempe [Open Data Portal](https://data.tempe.gov/dataset/high-severity-traffic-crashes-1-08), available at:
...
You will need the dplyr **group_by()** and **summary()** functions. 
